...
syn region doxygenDef matchgroup=markdownListMarker start="\\[a-z]" end="[a-z0-9]*" keepend oneline
syn region doxygenEqn matchgroup=markdownBlockquote start="\\f[{$[]" end="\\f[}$\]]" keepend contains=doxygenDef
