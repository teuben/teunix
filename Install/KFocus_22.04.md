...
4. Going to sleep is very unreliable, it fails more than it works. It happily will get hot and run the battery
   down in a few hours at about 7W usage.

5. There are still issues with the mouse or desktop. I then need to use ctrl-alt-F2 and F1 to get back to plasma.
